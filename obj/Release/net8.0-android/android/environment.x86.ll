...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 237674777, ; hash 0xe2aa119, from name: libaot-GymEquipmentsStore.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 408760122, ; hash 0x185d2f3a, from name: aot-GymEquipmentsStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GymEquipmentsStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 58
	...
	%struct.DSOCacheEntry {
		i64 1315165619, ; hash 0x4e63d5b3, from name: GymEquipmentsStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GymEquipmentsStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 173
	...
	%struct.DSOCacheEntry {
		i64 2597558982, ; hash 0x9ad39ac6, from name: libaot-GymEquipmentsStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GymEquipmentsStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 385
	...
	%struct.DSOCacheEntry {
		i64 3603577040, ; hash 0xd6ca38d0, from name: aot-GymEquipmentsStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GymEquipmentsStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 534
	...
	%struct.DSOCacheEntry {
		i64 3975594101, ; hash 0xecf6c075, from name: GymEquipmentsStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GymEquipmentsStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 586
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [134 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
